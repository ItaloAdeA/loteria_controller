...
def numeros_provaveis_de_sair_proximo_jogo(ultimo_jogo: list[int], maior_numero_apostavel: int) -> list[int]:
    ...
    caminho_arquivo_ref = "C:/Users/italo/Documents/codpy/analise_loteria/lotofacil/src/arquivos_referencias/contagem_dado_um_numero_qual_numero_mais_sai_prox_jogo.csv"
...
def numeros_provaveis_de_sair_em_conjunto(analise_prox_jogo: list[int], maior_numero_apostavel: int) -> list[list[int]]:
    ...
    caminho_arquivo_ref = "C:/Users/italo/Documents/codpy/analise_loteria/lotofacil/src/arquivos_referencias/contagem_saida_dado_numero_no_mesmo_jogo.csv"
    df = pd.read_csv(caminho_arquivo_ref)
...
def analisar_ciclo_dezenas(maior_numero_apostavel, arquivo_xlsx: str, quantidade_numeros_sorteados: int, corretor_media_ciclos: int) -> list[int]:
    ...
    caminho_arquivo_ref = "C:/Users/italo/Documents/codpy/analise_loteria/lotofacil/src/arquivos_referencias/media_ciclos_das_dezenas.csv"
    df = pd.read_csv(caminho_arquivo_ref)
...
def montar_jogo_com_base_nos_numeros_impares_pares(lista_numeros: list[int], quantidade_numeros_apostada: int) -> list[list[int]]:
    ...
    df_pares_impar = pd.read_csv("C:/Users/italo/Documents/codpy/analise_loteria/lotofacil/src/arquivos_referencias/contagem_pares_impares_mesmo_jogo.csv")
...
def execute_sugestao_jogos(
    ...
    df_final_spec.to_csv("C:/Users/italo/Documents/codpy/analise_loteria/lotofacil/src/sugestao_jogos_spec.csv", index=False)

    df_final = df_final.drop(columns=["qtd_n_faltas_jogo"])
    df_final.to_csv("C:/Users/italo/Documents/codpy/analise_loteria/lotofacil/src/sugestao_jogos.csv", index=False)
